...
$MultiPinDevices =
	"USB\VID_143C&PID_99AA&MI_00" # AL3D
	"USB\VID_143C&PID_99BB&MI_00" # AL3Di
...
$ConnectedDev = $ConnectedDev -like "*VID_143C*"
...
foreach ($subtree in $SearchTrees)
{
    ...
    $Items = $Items | Where { $_.DeviceInstance -like "*VID_143C*" }
