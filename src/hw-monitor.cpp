...
namespace librealsense
{
    ...
    hw_monitor::send( command cmd, hwmon_response * p_response, bool locked_transfer ) const
    {
        ...
        //al3d debug
        //LOG_INFO("send hw-monitot opCodeXmit =======>  "  << opCodeXmit );
        //LOG_INFO("al3d  newCommand.param1 =======> " << newCommand.param1);
        //LOG_INFO("al3d  newCommand.param2 =======> " << newCommand.param2);
        //LOG_INFO("al3d  newCommand.param3 =======> " << newCommand.param3);
        //LOG_INFO("al3d  newCommand.param4 =======> " << newCommand.param4);
        //LOG_INFO("al3d  newCommand.sizeOfSendCommandData =======> " << newCommand.sizeOfSendCommandData);
        ...
        //LOG_INFO("al3d  newCommand.receivedOpcode =======> " << newCommand.receivedOpcode);
        //LOG_INFO("al3d  newCommand.receivedCommandDataLength =======> " << newCommand.receivedCommandDataLength);
