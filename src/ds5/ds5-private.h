...
namespace librealsense
{
    namespace ds
    {
        ...
        //const platform::extension_unit depth_xu = { 0, 3, 3,
        { 0xC9606CCB, 0x594C, 0x4D25,{ 0xaf, 0x47, 0xcc, 0xc4, 0x96, 0x43, 0x59, 0x95 } } };
        //    c9606ccb -  594c -  4d25 -   af    47 -  cc    c4    96    43    59    95
        const platform::extension_unit fisheye_xu = { 3, 12, 2,
        { 0xf6c3c3d1, 0x5cde, 0x4477,{ 0xad, 0xf0, 0x41, 0x33, 0xf5, 0x8d, 0xa6, 0xf4 } } };

        //al3d fw_upgrade_xu  
        //node:4  entity/unit:6  guid:  23e49ed0-1178-4f31-ae52-d2fb8a8d3b48
        const platform::extension_unit fw_upgrade_xu = { 0, 6, 4,
       { 0x23e49ed0, 0x1178, 0x4f31,{ 0xae, 0x52, 0xd2, 0xfb, 0x8a, 0x8d, 0x3b, 0x48 } } };
        const uint8_t fw_upgrade_cs_cmd      = 0x04;
        const uint8_t fw_upgrade_cs_result   = 0x05;
        const uint8_t fw_upgrade_cs_set_data = 0x0d;
