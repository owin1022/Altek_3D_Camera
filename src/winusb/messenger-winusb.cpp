...
namespace librealsense
{
    namespace platform
    {
        ...
        usb_status usb_messenger_winusb::isoc_transfer(const std::shared_ptr<usb_endpoint>&  endpoint, uint8_t* buffer, uint32_t length, uint32_t& transferred, uint32_t timeout_ms)
        {
            return RS2_USB_STATUS_SUCCESS;
        }
