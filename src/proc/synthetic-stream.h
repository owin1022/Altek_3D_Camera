...
namespace librealsense
{
    ...
    protected:
		...
		void configure_processing_callbackEx();

        std::shared_ptr<stream_profile_interface> _source_stream_profile;
		std::shared_ptr<stream_profile_interface> _depth_target_stream_profile; 
        ...
        rs2_format _depth_target_format;
        rs2_stream _depth_target_stream;
        rs2_extension _depth_extension_type;
		...
		int _depth_target_bpp = 0;
        int _left_target_bpp = 0;
        int _right_target_bpp = 0;
		int _depth_target_profile_idx = 0;
